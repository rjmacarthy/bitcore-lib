...
stratcore provides full support for [BIP32](https://github.com/stratis/bips/blob/master/bip-0032.mediawiki), allowing for many key management schemas that benefit from this property. Please be sure to read and understand the basic concepts and the warnings on that BIP before using these classes.
...
var HDPrivateKey = stratcore.HDPrivateKey;
...
There was a bug that was discovered with derivation that would incorrectly calculate the child key against the [BIP32 specification](https://github.com/stratis/bips/blob/master/bip-0032.mediawiki).

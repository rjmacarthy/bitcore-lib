...
var HDPublicKey = stratcore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = stratcore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(stratcore.crypto.BN.prototype, 'toBuffer').callsFake(function (args) {
      ...
      sandbox.spy(stratcore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      stratcore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = stratcore.PublicKey.fromPoint;
      stratcore.PublicKey.fromPoint = function() {
        stratcore.PublicKey.fromPoint = unstubbed;

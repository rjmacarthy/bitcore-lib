# Public Key
Represents a stratis public key and is needed to be able to receive stratis, as is usually represented as a stratis [Address](address.md). See the official [Stratis Wiki](https://en.stratis.it/wiki/Technical_background_of_version_1_Stratis_addresses).

A PublicKey in stratcore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK2 = new stratcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = stratcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+

...
var BufferWriter = stratcore.encoding.BufferWriter;
var BufferReader = stratcore.encoding.BufferReader;
...
describe("Output", function() {
  ...
  it("#toObject roundtrip will handle an invalid (null) script", function() {
    ...
    var br = new stratcore.encoding.BufferReader(invalidOutputScript);
